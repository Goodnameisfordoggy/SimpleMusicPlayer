    ...
    class ConfigurationFilesMenu(object):
        ...
        def build_menu(self) -> None:
            ...
            action_json1 = PackingCreateMethod.my_action(
                ...
                triggered_callback=lambda: self.open_selected_file(CONFIG_FOLDER_PATH + r'\PlayerConfig.json'),
            ...
            action_json2 = PackingCreateMethod.my_action(
                parent=self.setting_menu.main_window,
                text="PlayerStyle.js",
                triggered_callback=lambda: self.open_selected_file(CONFIG_FOLDER_PATH + r'\PlayerStyle.json'),
                Icon_path=IMAGE_FOLDER_PATH + r"\Json File Image.png",
                superior=self.secmenu_setting_files
            )
            action_css = PackingCreateMethod.my_action(
                ...
                triggered_callback=lambda: self.open_selected_file(CONFIG_FOLDER_PATH + r'\PlayerStyle.css'),
